...
// Source File Name:   WindowsFontChooserUI.java
...
public class WindowsFontChooserUI extends FontChooserUI {
	...
	protected void installComponents() {
		...
		fontPanel = new JPanel(new PercentLayout(1, 2));
		JLabel label;
		...
		JPanel fontEffectPanel = new JPanel(new PercentLayout(1, 2));
		...
		fontEffectList.setSelectionMode(0);
		FontStyle fontStyles[] = {
			new FontStyle(0, bundle.getString("FontChooserUI.style.plain")), new FontStyle(1, bundle.getString("FontChooserUI.style.bold")), new FontStyle(2, bundle.getString("FontChooserUI.style.italic")), new FontStyle(3, bundle.getString("FontChooserUI.style.bolditalic"))
		};
		fontEffectList.setListData(fontStyles);
		fontSizePanel = new JPanel(new PercentLayout(1, 2));
		...
		JPanel charSetPanel = new JPanel(new PercentLayout(0, 2));
	...
	protected void installListeners() {
		...
		chooser.addPropertyChangeListener("selectedFont", propertyListener);
	}
	...
	private void updateSelectedFont() {
		...
		String fontFamily = currentFont != null ? currentFont.getName() : "SansSerif";
		int fontSize = currentFont != null ? currentFont.getSize() : 11;
